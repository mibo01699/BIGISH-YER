// ============================================
// BIGISH-YER Wallet — Navigation & Mining (v2)
// ============================================

// ============================================
// دالة التنقل بين الصفحات (مهمة جداً - لا تحذفها)
// ============================================
function showPage(pageName) {
    try {
        ...
        if (pageName === 'home' && typeof loadBalance === 'function') loadBalance();
...
async function startMining() {
    ...
    try {
        ...
        if (data.success) {
            ...
            miningInterval = setInterval(refreshMiningStatus, 60000);
